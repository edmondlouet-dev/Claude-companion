...
const WHY: Partial<Record<string, string>> = {
  ...
  cleanser:    'A gentle cleanser removes overnight sebum without stripping the barrier — a clean slate for actives.',
...
export const Today: React.FC = () => {
  ...
  const { owned, streak, activeRitual, user } = useStore();
  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        <View style={styles.brandRow}>
          ...
          <View style={styles.streak}>
            <Svg width={14} height={14} viewBox="0 0 24 24">
              <Path
                d="M12 3c0 4-4 5-4 9a4 4 0 0 0 8 0c0-2-1-3-2-4 0 2-1 3-2 3 0-3 0-5 0-8z"
        ...
        {/* Routine list — no strikethrough; row dims on completion */}
        {routine.map((step, i) => (
          <RoutineRow
            key={step.name}
            idx={i + 1}
